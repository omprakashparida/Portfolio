...
const App = () => {
    ...
    const [activeProject, setActiveProject] = useState('devmate');
    // Typing effect
    useEffect(() => {
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 md:grid-rows-2 gap-6 auto-rows-auto md:auto-rows-[250px]">
                        ...
                        <div className="md:col-span-2 md:row-span-1 bg-white/[0.02] border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:bg-white/[0.04] transition-colors group relative overflow-hidden backdrop-blur-sm">
                            ...
                            <div>
                                ...
                                <p className="text-gray-400 max-w-md">Building fluid, responsive, and highly interactive user interfaces and cloud editor panels using modern React architecture.</p>
                            </div>
                            <div className="flex flex-wrap gap-2 mt-4">
                                ...
                                <span className="bg-blue-500/10 border border-blue-500/20 px-3 py-1 rounded-full text-xs text-blue-300">Monaco Editor</span>
                            </div>
                        </div>

                        {/* Box 2: Logic & Algorithms (Tall) */}
                        ...
                        <div className="md:col-span-1 md:row-span-1 bg-white/[0.02] border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:bg-white/[0.04] transition-colors backdrop-blur-sm relative overflow-hidden">
                            <div className="absolute bottom-0 right-0 w-32 h-32 bg-cyan-500/10 rounded-full blur-[50px]"></div>
                            <div className="relative z-10">
                                <i className="fas fa-server text-green-400 text-3xl mb-4"></i>
                                <h4 className="text-xl font-bold text-white mb-2">Backend & Real-Time</h4>
                                <p className="text-gray-400 text-sm">Architecting secure REST APIs and managing bi-directional event-driven WebSocket concurrency.</p>
                            </div>
                            <div className="flex flex-wrap gap-2 mt-4 relative z-10">
                                ...
                                <span className="bg-cyan-500/20 border border-cyan-500/30 px-3 py-1 rounded-full text-xs text-cyan-300">Socket.io</span>
                                <span className="bg-blue-500/20 border border-blue-500/30 px-3 py-1 rounded-full text-xs text-blue-300">WebSockets</span>
                            </div>
                        </div>
                        ...
                        <div className="md:col-span-1 md:row-span-1 bg-white/[0.02] border border-white/10 rounded-3xl p-8 flex flex-col justify-between hover:bg-white/[0.04] transition-colors backdrop-blur-sm relative overflow-hidden">
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-gray-400 text-sm">Leveraging LLMs to build dynamic data generation pipelines and automated code auditing.</p>
                            </div>
                            <div className="flex flex-wrap gap-2 mt-4 relative z-10">
                                <span className="bg-purple-500/20 border border-purple-500/30 px-3 py-1 rounded-full text-xs text-purple-300">Groq API</span>
                                <span className="bg-purple-500/20 border border-purple-500/30 px-3 py-1 rounded-full text-xs text-purple-300">Llama 3.3</span>
                            </div>
                        </div>
                    </div>
                </div>
            </section>
{/* Spotlight Showcase (Projects) - TABBED LAYOUT */}
<section id="projects" className="py-24 px-6 relative z-10">
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-10">
                        <h2 className="text-sm font-bold tracking-widest text-indigo-500 uppercase mb-3">Featured Work</h2>
                        <h3 className="text-3xl md:text-5xl font-bold text-white mb-8">Engineering Showcase</h3>
                    </div>

                    {/* Interactive Glassmorphic Pill Navigation */}
                    <div className="flex justify-center mb-16 relative z-20">
                        <div className="bg-[#0a0a0a]/80 backdrop-blur-xl border border-white/10 p-1.5 rounded-full inline-flex gap-2 shadow-2xl">
                            <button 
                                onClick={() => setActiveProject('devmate')} 
                                className={`px-6 sm:px-8 py-2.5 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 ${activeProject === 'devmate' ? 'bg-blue-500/20 text-blue-400 border border-blue-500/30 shadow-[0_0_15px_rgba(59,130,246,0.2)]' : 'text-gray-400 hover:text-white hover:bg-white/5 border border-transparent'}`}
                            >
                                <i className="fas fa-network-wired"></i> DevMate AI
                            </button>
                            <button 
                                onClick={() => setActiveProject('pathforge')} 
                                className={`px-6 sm:px-8 py-2.5 rounded-full text-sm font-medium transition-all duration-300 flex items-center gap-2 ${activeProject === 'pathforge' ? 'bg-indigo-500/20 text-indigo-400 border border-indigo-500/30 shadow-[0_0_15px_rgba(99,102,241,0.2)]' : 'text-gray-400 hover:text-white hover:bg-white/5 border border-transparent'}`}
                            >
                                <i className="fas fa-project-diagram"></i> PathForge
                            </button>
                        </div>
                    </div>

                    {/* Cross-fading Project Container */}
                    <div className="relative w-full">
                        
                        {/* 1. DevMate AI Project */}
                        <div className={`transition-all duration-700 ease-in-out ${activeProject === 'devmate' ? 'opacity-100 translate-y-0 relative z-10' : 'opacity-0 absolute top-0 left-0 w-full translate-y-8 pointer-events-none z-0'}`}>
                            <div className="bg-[#050505]/80 backdrop-blur-3xl border border-blue-500/20 rounded-[2.5rem] p-8 lg:p-12 shadow-2xl flex flex-col lg:flex-row-reverse items-center gap-12 lg:gap-20">
                                {/* Text Column */}
                                <div className="w-full lg:w-1/2 space-y-8">
                                    <div>
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <span className="text-blue-400 text-sm font-medium tracking-wider uppercase">Newly Shipped</span>
                                        </div>
                                        <h4 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-white mb-6 tracking-tight font-montserrat">
                                            DevMate <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-cyan-400">AI</span>
                                        </h4>
                                        <p className="text-gray-400 text-lg leading-relaxed">
                                            An AI-powered real-time collaborative coding environment. Engineered with WebSockets (Socket.io) for multi-user synchronization and integrated with Groq's Llama 3.3 for instantaneous, automated code auditing and review.
                                        </p>
                                    </div>

                                    <ul className="space-y-4 text-gray-300">
                                        <li className="flex items-start gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors">
                                            <div className="w-10 h-10 rounded-full bg-blue-500/20 flex items-center justify-center shrink-0">
                                                <i className="fas fa-network-wired text-blue-400"></i>
                                            </div>
                                            <div>
                                                <strong className="block text-white mb-1">Real-Time Concurrency</strong>
                                                <span className="text-sm text-gray-400">Bi-directional code sync via WebSockets with room-isolated state management.</span>
                                            </div>
                                        </li>
                                        <li className="flex items-start gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 backdrop-blur-sm hover:bg-white/10 transition-colors">
                                            ...
                                            <div>
                                                <strong className="block text-white mb-1">AI Code Auditing</strong>
                                                <span className="text-sm text-gray-400">Instant security analysis and bug detection via Groq API (Llama 3.3 70B).</span>
                                            </div>
                                        </li>
                                    </ul>

                                    <div className="flex flex-wrap gap-4 pt-4">
                                        <a href="https://devmate-ai-phi.vercel.app" target="_blank" rel="noreferrer" className="bg-blue-600 hover:bg-blue-500 text-white px-8 py-3.5 rounded-full font-medium transition-all shadow-[0_0_20px_rgba(59,130,246,0.3)] flex items-center gap-2">
                                            Launch App <i className="fas fa-arrow-right"></i>
                                        </a>
                                        <a href="https://github.com/omprakashparida/DevMate-AI" target="_blank" rel="noreferrer" className="bg-white/5 border border-white/10 hover:bg-white/10 text-white px-8 py-3.5 rounded-full font-medium transition-all flex items-center gap-2">
                                            <i className="fab fa-github"></i> Source Code
                                        </a>
                                    </div>
                                </div>

                                {/* Visual Column: Code Editor Mockup */}
                                <div className="w-full lg:w-1/2 relative group perspective-1000">
                                    <div className="absolute inset-0 bg-gradient-to-r from-blue-500 to-cyan-600 rounded-3xl blur-2xl opacity-20 group-hover:opacity-40 transition-opacity duration-700"></div>
                                    <div className="relative bg-[#1e1e1e] border border-white/10 rounded-3xl overflow-hidden shadow-2xl backdrop-blur-xl transform transition-transform duration-500 hover:-rotate-y-2 hover:-rotate-x-2">
                                        <div className="flex items-center px-6 py-4 bg-[#252526] border-b border-black/50">
                                            <div className="flex gap-2">
                                                <div className="w-3 h-3 rounded-full bg-red-500/80"></div>
                                                <div className="w-3 h-3 rounded-full bg-yellow-500/80"></div>
                                                <div className="w-3 h-3 rounded-full bg-green-500/80"></div>
                                            </div>
                                            <div className="mx-auto text-xs text-gray-400 font-mono tracking-wider">roomHandler.js - DevMate Editor</div>
                                        </div>
                                        <div className="p-5 sm:p-8 font-mono text-xs sm:text-sm md:text-base space-y-2 break-words">
                                            <div className="text-purple-400">import <span className="text-white">{'{'} Server {'}'}</span> from <span className="text-green-400">'socket.io'</span>;</div>
                                            <br />
                                            <div className="text-blue-400">io.on<span className="text-white">(</span><span className="text-green-400">'connection'</span><span className="text-white">, (socket) =&gt; {'{'}</span></div>
                                            <div className="pl-4 text-gray-500">// Synchronizing collaborative room state</div>
                                            <div className="pl-4 text-white">socket.join(roomId);</div>
                                            <div className="pl-4 text-blue-400">emit<span className="text-white">(</span><span className="text-green-400">'user_joined'</span><span className="text-white">, {'{'} userId {'}'});</span></div>
                                            <div className="text-white">{'}'});</div>
                                            <br />
                                            <div className="flex items-center gap-3 mt-4 pt-4 border-t border-white/10">
                                                <span className="text-cyan-400 animate-pulse text-lg">●</span> 
                                                <span className="text-gray-300">AI Review: Optimal implementation. No race conditions detected.</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {/* 2. PathForge Project */}
                        <div className={`transition-all duration-700 ease-in-out ${activeProject === 'pathforge' ? 'opacity-100 translate-y-0 relative z-10' : 'opacity-0 absolute top-0 left-0 w-full translate-y-8 pointer-events-none z-0'}`}>
                            <div className="bg-[#050505]/80 backdrop-blur-3xl border border-indigo-500/20 rounded-[2.5rem] p-8 lg:p-12 shadow-2xl flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
                                {/* Text Column */}
                                <div className="w-full lg:w-1/2 space-y-8">
                                    <div>
                                        <div className="flex items-center gap-3 mb-4">
                                ...
                                {/* Visual Column: Abstract Terminal UI */}
                                <div className="w-full lg:w-1/2 relative group perspective-1000">
